...
concommand.Add( "XFuscate", function( _, _, arg, str )
    if arg and arg[1] then
        if arg[1] == '-h' or arg[1] == '-help' then
            --print("-- XFUSCATOR : THE BEST LUA OBFUSCATOR 3V4R --")
            --print("Copyright (C) 2012-2013 LoDC")
            print("")
            print("Usage: XFuscate <script.lua> [options]")
            print("  Obfuscates script.lua and writes the obfuscated code to <script [Obfuscated].lua>")
            print("")
            print("Other usage: XFuscate")
            ...
            print("  -loadstring     Precompiles code with CompileString, along with encrypting locals")
            print("  -noloadstring   Does not precompile code with CompileString")
